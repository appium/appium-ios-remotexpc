...
/** Structure of a pairing request message sent to the peer */
...
/** Interface for executing the Remote Pairing Pair-Setup flow */
export interface PairingProtocolInterface {
  executePairingFlow(device: RemotePairingDevice): Promise<string>;
}
