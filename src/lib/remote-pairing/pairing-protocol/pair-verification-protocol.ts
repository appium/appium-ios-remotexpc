...
/**
 * Implements the HomeKit Accessory Protocol (HAP) Pair-Verify process for Remote Pairing.
 *
 * Protocol Overview:
 * This class implements the HAP Pair-Verify protocol, which establishes an encrypted
 * session between a previously paired controller (this client) and the peer device.
