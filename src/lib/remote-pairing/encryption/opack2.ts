...
import { RemotePairingError } from '../errors.js';
...
export class Opack2 {
   ...
   * @throws RemotePairingError if the object contains unsupported types
   */
   ...
   * @throws RemotePairingError for unsupported types
   */
  ...
  private static encodeNumber(num: number): Buffer {
    ...
    throw new RemotePairingError(
      `Number too large for OPACK2 encoding: ${num}`,
    );
  }
