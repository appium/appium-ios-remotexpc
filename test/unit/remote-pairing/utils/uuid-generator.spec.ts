...
import { generateHostId } from '../../../../src/lib/remote-pairing/utils/uuid-generator.js';

describe('uuid-generator', function () {
  describe('generateHostId', function () {
    it('should generate deterministic UUID from hostname', function () {
    ...
    it('should generate different UUIDs for different hostnames', function () {
